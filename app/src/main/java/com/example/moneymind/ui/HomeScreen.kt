...
private enum class OptionSection {
    FILE,
    MANUAL,
    PROFILE,
    CONTROL
...
private enum class LedgerViewMode {
    CALENDAR,
    CHECKLIST
}

private enum class EntryTypeFilter {
    ALL,
    INCOME,
    EXPENSE,
    TRANSFER
...
private enum class PaymentMethodFilter {
    ALL,
    CARD,
    BANK,
    CASH,
...
private enum class MainChartTab {
    USAGE,
    FLOW_6M,
    CATEGORY,
    TRIAGRAM
...
@Composable
private fun MainDashboardPage(state: HomeUiState) {
    LazyColumn(
